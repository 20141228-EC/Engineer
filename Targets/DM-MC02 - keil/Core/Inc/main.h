...
#define LEFT_AXIS_X_Pin GPIO_PIN_0
#define LEFT_AXIS_X_GPIO_Port GPIOA
#define RIGHT_AXIS_X_Pin GPIO_PIN_2
#define RIGHT_AXIS_X_GPIO_Port GPIOA
...
#define SWITCH_ARM_ROLL_END_Pin GPIO_PIN_9
#define SWITCH_ARM_ROLL_END_GPIO_Port GPIOE
...
#define SWITCH_CHASSIS_Pin GPIO_PIN_13
#define SWITCH_CHASSIS_GPIO_Port GPIOE
