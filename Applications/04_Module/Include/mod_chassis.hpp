...
#define CHASSIS_HIP_ECD_MAX_L   10.2f//1685.f//
#define CHASSIS_HIP_ECD_MIN_L   0.f//0.0f
#define CHASSIS_HIP_ECD_MAX_R   0.f//0.0f
#define CHASSIS_HIP_ECD_MIN_R   -10.7f//-1717.f//        ///< 这几个是极限腿长时候两个电机对应的编码值 即软件限位 待改
...
#define IS_CLIMBED_TOR_DIFF 0.2f    // 已经上了台阶的前后轮组扭矩差判断阈值
