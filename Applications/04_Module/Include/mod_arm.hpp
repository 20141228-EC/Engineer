...
/*-------------------------------------物理限位---------------------------------------------------*/
#define ARM_YAW_PHYSICAL_RANGE_MIN -171.5f
#define ARM_YAW_PHYSICAL_RANGE_MAX 171.5f
#define ARM_PITCH1_PHYSICAL_RANGE_MIN 0.0f
#define ARM_PITCH1_PHYSICAL_RANGE_MAX 103.f
#define ARM_PITCH2_PHYSICAL_RANGE_MIN 0.f
#define ARM_PITCH2_PHYSICAL_RANGE_MAX 134.f
#define ARM_PITCH3_PHYSICAL_RANGE_MIN -47.6f
#define ARM_PITCH3_PHYSICAL_RANGE_MAX 3.46f
...
/*-------------------------------------电机限位----------------------------------------------------*/
//原始限位编码器器范围
#define ARM_YAW_MOTOR_RANGE 62637
#define ARM_PITCH1_MOTOR_RANGE 18703
#define ARM_PITCH2_MOTOR_RANGE 24185
#define ARM_END_PITCH_MOTOR_RANGE 279591
#define ARM_END_GRIP_MOTOR_RANGE 1212382     ///(8192*22+10240+11000)
