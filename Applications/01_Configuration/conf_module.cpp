...
EAppStatus InitAllModule() {
    ...
    armInitParam.MotorID_length_L = EDeviceID::DEV_ARM_MTR_GRIPPER;
    // 设置can发送节点
    ...
    armInitParam.MotorTxNode_length_L = &TxNode_Can2_1FF;
    // armInitParam.MotorTxNode_length_L = &TxNode_Can2_1FF;
    // armInitParam.MotorTxNode_length_R = &TxNode_Can2_1FF;
   ...
   armInitParam.endPosPidParam.kp = 0.1f;
   ...
   armInitParam.endSpdPidParam.kp = 2.0f;
   armInitParam.endSpdPidParam.ki = 0.1f;
   ...
   armInitParam.endSpdPidParam.maxOutput = 4500.0f;
    ...
    // 初始化 LengthPosPidParam 的成员
    armInitParam.LengthPosPidParam.kp = 1.0;
    armInitParam.LengthPosPidParam.ki = 0.1f;
    armInitParam.LengthPosPidParam.kd = 0.0f;
    armInitParam.LengthPosPidParam.maxOutput = 4000.0f;
    // 初始化 LengthSpdPidParam 的成员
    armInitParam.LengthSpdPidParam.kp = 0.2f;
    armInitParam.LengthSpdPidParam.ki = 0.0f;
    armInitParam.LengthSpdPidParam.kd = 0.0f;
    armInitParam.LengthSpdPidParam.maxIntegral = 4000.0f;
    armInitParam.LengthSpdPidParam.maxOutput = 4500.0f;
