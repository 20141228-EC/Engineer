...
//    armInitParam.Pitch1PosPidParam.Grav_Load_Mode = CAlgoPid::EGravLoadMode::END_ROLL_G; ///< 末端roll的重补模式
   ...
   /******初始化云台模块******/
    ...
    gimbalInitParam.YawPosPidParam_Gyro.kp = 10.f;
    ...
    gimbalInitParam.YawPosPidParam_Gyro.maxOutput = 6000.f;

    gimbalInitParam.YawSpdPidParam_Gyro.kp = 6.f;
    gimbalInitParam.YawSpdPidParam_Gyro.ki = 1.f;
