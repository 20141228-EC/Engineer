...
EAppStatus InitAllDevice(){
    ...
    ******************************************/
    ...
    // static CDevMtrM2006 armMotor_Length_L;
    // CDevMtrM2006::SMtrInitParam_M2006 armMotor_Length_L_initparam;
    // armMotor_Length_L_initparam.deviceID = EDeviceID::DEV_ARM_MTR_LENGTH_L;
    // armMotor_Length_L_initparam.interfaceID = EInterfaceID::INF_CAN2;
    // armMotor_Length_L_initparam.djiMtrID = CDevMtrDJI::EDjiMtrID::ID_1;
    // armMotor_Length_L_initparam.useAngleToPosit = true;
    // armMotor_Length_L_initparam.useStallMonit = true;
    // armMotor_Length_L_initparam.stallThreshold = 1000.0f; // 设置
    // armMotor_Length_L_initparam.stallMonitDataSrc = CDevMtr::DATA_TORQUE;
    // armMotor_Length_L.InitDevice(&armMotor_Length_L_initparam);

    // static CDevMtrM2006 armMotor_Length_R;
    // CDevMtrM2006::SMtrInitParam_M2006 armMotor_Length_R_initparam;
    // armMotor_Length_R_initparam.deviceID = EDeviceID::DEV_ARM_MTR_LENGTH_R;
    // armMotor_Length_R_initparam.interfaceID = EInterfaceID::INF_CAN2;
    // armMotor_Length_R_initparam.djiMtrID = CDevMtrDJI::EDjiMtrID::ID_2;
    // armMotor_Length_R_initparam.useAngleToPosit = true;
    // armMotor_Length_R_initparam.useStallMonit = true;
    // armMotor_Length_R_initparam.stallThreshold = 1000.0f; // 设置
    // armMotor_Length_R_initparam.stallMonitDataSrc = CDevMtr::DATA_TORQUE;
    // armMotor_Length_R.InitDevice(&armMotor_Length_R_initparam);

    // 夹爪电机
    static CDevMtrM2006 armMotor_Gripper;
    CDevMtrM2006::SMtrInitParam_M2006 armMotor_Gripper_initparam;
    armMotor_Gripper_initparam.deviceID = EDeviceID::DEV_ARM_MTR_GRIPPER;
    armMotor_Gripper_initparam.interfaceID = EInterfaceID::INF_CAN2;
    armMotor_Gripper_initparam.djiMtrID = CDevMtrDJI::EDjiMtrID::ID_8;
    armMotor_Gripper_initparam.useAngleToPosit = true;
    armMotor_Gripper_initparam.useStallMonit = true;
    armMotor_Gripper_initparam.stallThreshold = 1000.0f; // 设置
    armMotor_Gripper_initparam.stallMonitDataSrc = CDevMtr::DATA_TORQUE;
    armMotor_Gripper.InitDevice(&armMotor_Gripper_initparam);
