...
void CSystemCore::StartPushOreTask(void *arg) {
	...
	while (keyboard.key_Ctrl) {
		...
		if (keyboard.mouse_L) {
			...
			core.parm_->armCmd.set_angle_Pitch1 = 69.902f;
			core.parm_->armCmd.set_angle_Pitch2 = 64.212f;
			core.parm_->armCmd.set_angle_Roll = -1.48f;
			core.parm_->armCmd.set_angle_end_pitch = -108.415f;
			core.parm_->armCmd.set_angle_end_roll -= 26.640f;
			...
			proc_waitMs(250);
			core.psubgantry_->subGantryCmd.setStretchPosit_L = 92.0f;
		...
		if (keyboard.mouse_R) {
			...
			core.parm_->armCmd.set_angle_end_roll += 36.01511f;
			...
			proc_waitMs(250);
			core.parm_->armCmd.set_angle_Yaw = -47.90588f;
			...
			// core.parm_->armCmd.set_angle_Yaw = 21.35f;
			proc_waitMs(250);
			core.psubgantry_->subGantryCmd.setStretchPosit_R = 75.7967758f; //60.0f;
