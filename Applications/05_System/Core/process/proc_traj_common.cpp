 ...
 ******************************************************************************/
 ...
 namespace my_engineer{
    ...
    const float_t Traj_Grab[][FC_COUNT] = {
        ...
        { 8000,   78.2f,  27.24f,  32.85f,   -50.86f,  188.248f,  -0.427f,         1.8f,        1 ,      0.8f},
    ...
    const float_t Traj_Get[][FC_COUNT] = {  //由于灯条的干涉所以大部分的时间都是夹取的状态
        // time      yaw        p1          p2       p3       roll        endP        endR       grip       speed
        ...
        //{  3000,   61.8f,  38.32f,  40.438f,   -64.920f,  185.179f,  10.427f,       0.f,        1 ,      1.f},  //
         ...
         {  3000,   68.8f,  20.32f,  23.438f,   -41.920f,  185.179f,  -26.427f,       1.8f,        0 ,      1.f},  //
         {  4000,   68.8f,  20.32f,  20.438f,   -38.920f,  185.179f,  -26.427f,       2.f,        0 ,      1.f},  //
