 ...
 ******************************************************************************/
 ...
 namespace my_engineer{
    ...
    const float_t Traj_Grab[][FC_COUNT] = {
        ...
        { 4000,   78.2f,  65.84f,  41.52f,   -77.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  
        ...
        { 6000,   78.2f,  57.24f,  34.85f,   -75.86f,  188.248f,  -121.427f,         1.8f,        0 ,      0.5f},
        { 7000,   78.2f,  57.24f,  34.85f,   -75.86f,  188.248f,  -121.427f,         1.8f,        1 ,      0.5f},
        { 8000,   81.02f,  36.65f,  30.75f,   -67.86f,  190.248f,  -145.427f,         -8.f,        1 ,      1.0f},
        { 9000,   81.02f,  27.65f,  30.75f,   -67.86f,  190.248f,  -144.427f,         -8.f,        1 ,      1.0f},
         { 10000,   81.02f,  21.65f,  30.75f,   -67.86f,  190.248f,  -144.427f,         -8.f,        1 ,      1.0f},
         { 11000,   -2.02f,  22.65f,  30.75f,   -67.86f,  190.248f,  -144.427f,         -8.f,        1 ,      1.0f},
         { 12000,   -2.02f,  52.45f,  43.75f,   -1.86f,  189.248f,  -68.427f,         -8.f,        1 ,      1.3f},
    ...
    const float_t Traj_Get[][FC_COUNT] = {
        // time      yaw        p1          p2       p3       roll        endP        endR       grip       speed
        {      0,   73.2f,   29.35f,  46.808f,   -70.89f,   184.24f,   -88.36f,       0.f,        1 ,      1.3f},  // 起始位
        {  1000,   73.9f,  22.32f,  33.438f,   -59.920f,  190.179f,  -76.427f,       0.f,        1 ,      1.f},  // 
        {  2000,   73.9f,  29.91f,  30.34f,   -66.484f,  182.2f,  -81.427f,          1.f,        1,      0.7f},  
        {  3000,   73.9f,  39.91f,  30.14f,   -66.484f,  184.2f,  -81.427f,          1.f,        1,      0.7f},    
        {  4000,   73.9f,  40.78f,  30.14f,   -66.484f,  184.2f,  -81.427f,          1.f,        1,      0.7f}, 
        {  4000,   73.9f,  43.78f,  30.14f,   -66.484f,  184.2f,  -81.427f,          1.f,        1,      0.7f},
        {  4000,   73.9f,  44.78f,  30.14f,   -66.484f,  184.2f,  -81.427f,          1.f,        1,      0.7f},   
        {  5000,   73.9f,  46.78f,  30.14f,   -66.484f,  184.2f,  -81.427f,          1.f,        0,      0.7f},    // 夹爪夹紧
        //{ 6000,   78.2f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  // <<<< 夹爪夹紧后

        //{ 7000,   78.2f,  12.24f,  29.85f,   -63.86f,  188.248f,  -121.427f,         1.8f,        0 ,      0.5f},
        
        { 7000,  78.2f,  15.24f,  29.85f,   -63.86f,  188.248f,  -121.427f,         1.8f,        0 ,      1.0f},//pitchend拔出来
        { 8000,   59.92f,  15.65f,  7.75f,   -0.86f,  196.248f,  -127.427f,         5.f,        0 ,      1.0f},
        { 9000,   -2.02f,  15.45f,  20.75f,   -1.86f,  189.248f,  -127.427f,         0.f,        0 ,      1.3f},
    ...
    bool PlaySegment(CModArm &arm, const float_t target[J::COUNT],
        ...
        player.PlanMultiAxisTraj(current, target);
        ...
        while(true){
            ...
            float_t elapsed = static_cast<float_t>(HAL_GetTick() - startTick) / 1000.0f;//转换成秒

            // 关节角度播放
            if(player.IsFinished(elapsed)) {
                WriteArmjoint(arm, target);
            } else {
                player.MultiAxisTrajDistance(elapsed, joints);
    ...
    bool PlayFrameSegment(CModArm &arm,
        ...
        return PlaySegment(arm, target, speed, gripClose, player, checkctrl);
    }
