 ...
 ******************************************************************************/
 ...
 namespace my_engineer{
    ...
    const float_t Traj_Grab_L[][FC_COUNT] = {
        ...
        {  1000,   74.8f,  39.32f,  45.438f,   -76.620f,  189.179f,  -121.427f,       1.8f,        0 ,      1.f},  // 
        {  2000,   74.8f,  36.81f,  35.34f,   -72.484f,  189.2f,  -121.427f,          1.8f,        0,      0.7f},  
        { 3000,   74.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 4000,   74.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 5000,   74.8f,  51.34f,  31.35f,   -61.86f,  184.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 6000,   74.8f,  61.24f,  37.52f,   -67.86f,  184.248f,  -118.427f,         1.8f,        0 ,      0.7f},  
        ...
        { 7000,   74.8f,  71.24f,  37.52f,   -69.86f,  184.248f,  -118.427f,         1.8f,        0 ,      0.5f},
        { 8000,   78.2f,  27.24f,  32.85f,   -50.86f,  188.248f,  -0.427f,         1.8f,        1 ,      0.8f},//松开之后
        { 9000,   80.02f,  27.65f,  50.75f,   -67.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.2f},
        { 10000,   79.02f,  27.65f,  53.75f,   -65.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
        { 11000,   78.02f,  21.65f,  54.75f,   -63.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
        { 12000,   -2.02f,  22.65f,  55.75f,   -60.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
    ...
    const float_t Traj_Grab_R[][FC_COUNT] = {
        // time      yaw        p1          p2       p3       roll        endP        endR       grip       speed
        {      0,   -62.31f,   36.62f,  51.35f,   -77.62f,   190.18f,   -121.33f,       -1.8f,        0 ,      1.2f},  // 起始位
        {  1000,   -63.8f,  39.32f,  45.438f,   -76.620f,  189.179f,  -121.427f,       -1.8f,        0 ,      1.f},  // 
        {  2000,   -69.8f,  36.81f,  35.34f,   -72.484f,  189.2f,  -121.427f,          -1.8f,        0,      0.9f},  
        { 3000,   -69.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         -1.8f,        0 ,      0.9f},
        { 4000,   -69.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         -1.8f,        0 ,      0.7f},
        { 5000,   -70.8f,  51.34f,  31.35f,   -61.86f,  184.248f,  -121.427f,         -1.8f,        0 ,      0.7f},
        { 6000,   -68.8f,  61.24f,  31.52f,   -67.86f,  184.248f,  -118.427f,         -1.8f,        0 ,      0.7f},  
        //{ 5000,   78.2f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  // 夹爪松开前 (t≈23s)
        //{ 6000,   78.2f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  // <<<< 夹爪松开后

        { 7000,   -69.8f,  70.24f,  34.52f,   -67.86f,  184.248f,  -110.427f,         -1.8f,        0 ,      0.5f},
        { 8000,   -69.8f,  75.24f,  32.52f,   -67.86f,  184.248f,  -105.427f,         -1.8f,        0 ,      0.5f},
        { 9000,   -69.8f,  65.24f,  18.52f,   -47.86f,  184.248f,  -100.427f,         -1.8f,        0 ,      0.5f},

        { 10000,   -67.2f,  27.24f,  32.85f,   -50.86f,  188.248f,  -0.427f,         1.8f,        1 ,      0.8f},//松开之后
        { 11000,   -68.02f,  27.65f,  50.75f,   -67.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.2f},
        { 12000,   -79.02f,  27.65f,  53.75f,   -65.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.2f},
        { 13000,   -78.02f,  27.65f,  54.75f,   -66.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
        { 14000,   -2.02f,  22.65f,  55.75f,   -60.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
        { 15000,   -2.02f,  52.45f,  43.75f,   -1.86f,  189.248f,  -68.427f,         -8.f,        1 ,      1.3f},
    ...
    const float_t Traj_Get_L[][FC_COUNT] = {  //由于灯条的干涉所以大部分的时间都是夹取的状态
        // time      yaw        p1          p2       p3       roll        endP        endR       grip       speed
        {      0,   22.8f,   18.35f,  45.808f,   -50.89f,   184.24f,   30.36f,       1.f,        0 ,      1.3f},  // 起始位//roll:188
        ...
        //{  3000,   61.8f,  38.32f,  40.438f,   -64.920f,  185.179f,  10.427f,       0.f,        1 ,      1.f},  //
         ...
         {  3000,   78.8f,  20.32f,  23.438f,   -41.920f,  185.179f,  -26.427f,       1.8f,        0 ,      1.f},  //
         {  4000,   78.8f,  20.32f,  20.438f,   -38.920f,  185.179f,  -40.427f,       2.f,        0 ,      1.f},  //

         {  5000,   78.8f,  42.32f,  20.438f,   -51.920f,  185.179f,  -90.427f,       2.f,        1 ,      1.f},  //
        {  6000,   78.8f,  36.32f,  17.438f,   -51.920f,  185.179f,  -85.427f,       1.f,        1 ,      1.f},  //
         
        {  7000,   78.8f,  40.91f,  14.14f,   -38.3f,  181.2f,  -69.427f,          1.f,        0,      0.7f},    
         {  8000,   78.8f,  17.91f,  16.14f,   -25.3f,  181.2f,  -24.427f,          1.f,        0,      0.7f},
    ...
    const float_t Traj_Get_R[][FC_COUNT] = {  //由于灯条的干涉所以大部分的时间都是夹取的状态
        ...
        {      0,   -22.8f,   18.35f,  45.808f,   -50.89f,   184.24f,   30.36f,       1.f,        0 ,      1.3f},  // 起始位//roll:188
        {  1000,   -22.8f,   18.35f,  45.808f,   -50.89f,   184.24f,   30.36f,       1.f,        0 ,      1.3f},  // 起始位
        {  2000,   -72.8f, 40.32f,  47.438f,   -67.920f,  185.179f,  30.427f,       1.8f,        0 ,      1.f},  // 
        //{  3000,   61.8f,  38.32f,  40.438f,   -64.920f,  185.179f,  10.427f,       0.f,        1 ,      1.f},  //

         {  3000,   -72.8f,  20.32f,  23.438f,   -41.920f,  185.179f,  -26.427f,       1.8f,        0 ,      1.f},  //
         {  4000,   -75.8f,  20.32f,  20.438f,   -38.920f,  185.179f,  -26.427f,       2.f,        0 ,      1.f},  //

         {  5000,   -75.8f,  45.32f,  24.438f,   -55.920f,  185.179f,  -97.427f,       2.f,        1 ,      1.f},  //
        {  6000,   -75.8f,  42.32f,  17.438f,   -44.920f,  185.179f,  -97.427f,       1.f,        1 ,      1.f},  //
         
        {  7000,   -67.8f,  40.91f,  14.14f,   -38.3f,  181.2f,  -69.427f,          1.f,        0,      0.7f},    
         {  8000,   -67.8f,  17.91f,  16.14f,   -25.3f,  181.2f,  -24.427f,          1.f,        0,      0.7f},
       
        
        { 9000,  -67.8f,  18.24f,  28.85f,   -63.86f,  188.248f,  -121.427f,         1.8f,        0 ,      1.0f},//pitchend拔出来
        { 10000,   -59.92f,  20.65f,  26.75f,   -40.86f,  196.248f,  -127.427f,         5.f,        0 ,      1.0f},
        { 11000,   -2.02f,  15.45f,  20.75f,   -1.86f,  189.248f,  -76.427f,         0.f,        0 ,      1.3f},
    };
    ...
    bool PlaySegment(CModArm &arm, const float_t target[J::COUNT],
        ...
        auto gripReached = [&arm](bool close) -> bool {
            ...
            float_t grip = arm.armCmd.set_length_grip;
            return close ? (grip <= tol || arm.armInfo.isGripped) : (grip >= 65.0f - tol);
        };
        /*-------------------------------------------------------*/
        ...
        WriteArmjoint(arm, target);
        arm.armCmd.gripClose = gripClose;
        arm.armCmd.gripOpen = !gripClose;
        return true;
    }
