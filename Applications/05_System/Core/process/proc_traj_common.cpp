 ...
 ******************************************************************************/
 ...
 namespace my_engineer{
    ...
    const float_t Traj_Grab_R[][FC_COUNT] = {
        // time      yaw        p1          p2       p3       roll        endP        endR       grip       speed
        {      0,   -79.31f,   36.62f,  51.35f,   -77.62f,   190.18f,   -121.33f,       1.8f,        0 ,      1.2f},  // 起始位
        {  1000,   -67.8f,  39.32f,  45.438f,   -76.620f,  189.179f,  -121.427f,       1.8f,        0 ,      1.f},  // 
        {  2000,   -70.8f,  36.81f,  35.34f,   -72.484f,  189.2f,  -121.427f,          1.8f,        0,      0.7f},  
        { 3000,   -70.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 4000,   -70.8f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 5000,   -70.8f,  51.34f,  31.35f,   -61.86f,  184.248f,  -121.427f,         1.8f,        0 ,      0.7f},
        { 6000,   -70.8f,  61.24f,  31.52f,   -67.86f,  184.248f,  -118.427f,         1.8f,        0 ,      0.7f},  
        //{ 5000,   78.2f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  // 夹爪松开前 (t≈23s)
        //{ 6000,   78.2f,  49.34f,  37.35f,   -71.86f,  187.248f,  -121.427f,         1.8f,        0 ,      0.7f},  // <<<< 夹爪松开后

        { 7000,   -70.8f,  70.24f,  34.52f,   -67.86f,  184.248f,  -130.427f,         1.8f,        0 ,      0.5f},
        { 8000,   -70.8f,  75.24f,  32.52f,   -67.86f,  184.248f,  -130.427f,         1.8f,        0 ,      0.5f},
        { 9000,   -70.8f,  70.24f,  23.52f,   -53.86f,  184.248f,  -140.427f,         1.8f,        0 ,      0.5f},
        ...
        { 12000,   -79.02f,  27.65f,  53.75f,   -65.86f,  190.248f,  20.427f,         -8.f,        1 ,      1.0f},
    ...
    const float_t Traj_Get_L[][FC_COUNT] = {  //由于灯条的干涉所以大部分的时间都是夹取的状态
        ...
        //{  3000,   61.8f,  38.32f,  40.438f,   -64.920f,  185.179f,  10.427f,       0.f,        1 ,      1.f},  //
         ...
         {  3000,   70.8f,  20.32f,  23.438f,   -41.920f,  185.179f,  -26.427f,       1.8f,        0 ,      1.f},  //
         {  4000,   70.8f,  20.32f,  20.438f,   -38.920f,  185.179f,  -40.427f,       2.f,        0 ,      1.f},  //

         {  5000,   70.8f,  33.32f,  17.438f,   -44.920f,  185.179f,  -62.427f,       2.f,        1 ,      1.f},  //
        {  6000,   70.8f,  36.32f,  17.438f,   -44.920f,  185.179f,  -70.427f,       1.f,        1 ,      1.f},  //
         
        {  7000,   70.8f,  40.91f,  14.14f,   -38.3f,  181.2f,  -69.427f,          1.f,        0,      0.7f},    
         {  8000,   70.8f,  17.91f,  16.14f,   -25.3f,  181.2f,  -24.427f,          1.f,        0,      0.7f},
    ...
    const float_t Traj_Get_R[][FC_COUNT] = {  //由于灯条的干涉所以大部分的时间都是夹取的状态
        ...
        //{  3000,   61.8f,  38.32f,  40.438f,   -64.920f,  185.179f,  10.427f,       0.f,        1 ,      1.f},  //
         ...
         {  4000,   -73.8f,  20.32f,  20.438f,   -38.920f,  185.179f,  -26.427f,       2.f,        0 ,      1.f},  //

         {  5000,   -74.8f,  33.32f,  17.438f,   -44.920f,  185.179f,  -62.427f,       2.f,        1 ,      1.f},  //
        {  6000,   -73.8f,  36.32f,  17.438f,   -44.920f,  185.179f,  -70.427f,       1.f,        1 ,      1.f},  //
