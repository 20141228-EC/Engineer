...
private:
	...
	CDevReferee::SRobotMsgPkg<CDevReferee::SUiDrawTextMsg> hipTextMsg, crawlerTextMsg, gripCloseTextMsg, modeTextMsg, curModeTextMsg, hipInfoTextMsg;
	...
	CDevReferee::SRobotMsgPkg<CDevReferee::SUiDrawSingleMsg> gripCloseMsg;
